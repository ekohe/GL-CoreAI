...
async function invokingCodeAnalysis(issueDetails: any, diffsData: any) {
  ...
  try {
    ...
    mainContainer.appendChild(createErrorContainer("OpenAI"));
  }
}
...
async function invokingMRAction(containerRef: any, diffsData: any, actionType: MRActionType) {
  ...
  try {
    ...
    MRActionsRenderer.showErrorState(mainContainer, "Failed to get response from OpenAI. Please try again.");
  }
}
...
async function invokingIssueAction(containerRef: any, issueData: any, discussions: any, actionType: IssueActionType) {
  ...
  try {
    ...
    IssueActionsRenderer.showErrorState(mainContainer, "Failed to get response from OpenAI. Please try again.");
  }
}
