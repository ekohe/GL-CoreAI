...
export class GitLabAPI {
  ...
  public static async postCodeSuggestion(
    ...
    try {
      ...
      const commentBody = `## 🚀 Code Improvement Suggestion: ${suggestionTitle}
    ...
    window.applyCodeSuggestion = async (index: number, line: string) => {
      ...
      try {
        ...
        if (success) {
          ...
          `;
          notification.textContent = '✅ Code suggestion posted to GitLab';
          ...
          if (button) {
            ...
            button.innerHTML = '🚀 Apply to GitLab';
          }
        }
      } catch (error) {
        if (button) {
